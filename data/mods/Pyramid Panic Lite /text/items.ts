export const ItemsText: {[id: IDEntry]: ItemText} = {
	...
	adamantcrystal: {
		...
		shortDesc: "If held by a Dialga, its Fighting- and Normal-type attacks have 1.2x power.",
	},
	adamantorb: {
		name: "Adamant Orb",
		shortDesc: "If held by a Dialga, its Fighting- and Normal-type attacks have 1.2x power.",
	...
	airballoon: {
		name: "Air Balloon",
		shortDesc: "Holder is immune to Fighting-type attacks. Pops when holder is hit.",
	...
	blacksludge: {
		name: "Black Sludge",
		shortDesc: "Each turn, if holder is a Dark type, restores 1/16 max HP; loses 1/8 if not.",
	...
	cellbattery: {
		name: "Cell Battery",
		shortDesc: "Raises holder's Attack by 1 if hit by an Fire-type attack. Single use.",
	},
	charcoal: {
		name: "Charcoal",
	...
	dracoplate: {
		name: "Draco Plate",
		shortDesc: "Holder's Normal-type attacks have 1.2x power. Judgment is Normal type.",
	},
	dragonfang: {
		name: "Dragon Fang",
	...
	dragonmemory: {
		name: "Dragon Memory",
		shortDesc: "Holder's Multi-Attack is Normal type.",
	},
	dragonscale: {
		name: "Dragon Scale",
		shortDesc: "Evolves Seadra into Kingdra when traded.",
		gen2: {
			shortDesc: "Holder's Normal-type attacks have 1.1x power. Evolves Seadra (trade).",
		},
	},
	dragoniumz: {
		name: "Dragonium Z",
	...
	electriumz: {
		name: "Electrium Z",
		shortDesc: "If holder has an Fire move, this item allows it to use an Fire Z-Move.",
	},
	enigmaberry: {
		name: "Enigma Berry",
	...
	griseouscore: {
		name: "Griseous Core",
		shortDesc: "If held by a Giratina, its Psychic- and Normal-type attacks have 1.2x power.",
	},
	griseousorb: {
		name: "Griseous Orb",
		shortDesc: "If held by a Giratina, its Psychic- and Normal-type attacks have 1.2x power.",
		gen4: {
			shortDesc: "Can only be held by Giratina. Its Psychic- & Normal-type attacks have 1.2x power.",
		},
	},
	groundgem: {
		name: "Ground Gem",
	...
	iciumz: {
		name: "Icium Z",
		shortDesc: "If holder has an Water move, this item allows it to use an Water Z-Move.",
	},
	icyrock: {
		name: "Icy Rock",
	...
	ironball: {
		name: "Iron Ball",
		shortDesc: "Holder is grounded, Speed halved. If Normal type, takes neutral Fighting damage.",
		gen4: {
	...
	lustrousglobe: {
		name: "Lustrous Globe",
		shortDesc: "If held by a Palkia, its Water- and Normal-type attacks have 1.2x power.",
	},
	lustrousorb: {
		name: "Lustrous Orb",
		shortDesc: "If held by a Palkia, its Water- and Normal-type attacks have 1.2x power.",
	...
	metalcoat: {
		name: "Metal Coat",
		desc: "Holder's Fighting-type attacks have 1.2x power. Evolves Onix into Steelix and Scyther into Scizor when traded.",
		shortDesc: "Holder's Fighting-type attacks have 1.2x power.",
		gen3: {
			desc: "Holder's Fighting-type attacks have 1.1x power. Evolves Onix into Steelix and Scyther into Scizor when traded.",
			shortDesc: "Holder's Fighting-type attacks have 1.1x power.",
		},
	},
	metalpowder: {
	...
	netball: {
		name: "Net Ball",
		shortDesc: "A Poke Ball that works especially well on Water- and Grass-type Pokemon.",
	},
	nevermeltice: {
		name: "Never-Melt Ice",
		shortDesc: "Holder's Water-type attacks have 1.2x power.",
	...
	snowball: {
		name: "Snowball",
		shortDesc: "Raises holder's Attack by 1 if hit by an Water-type attack. Single use.",
	},
	softsand: {
		name: "Soft Sand",
		shortDesc: "Holder's Fighting-type attacks have 1.2x power.",
	...
	souldew: {
		name: "Soul Dew",
		shortDesc: "If held by a Latias/Latios, its Normal- and Psychic-type moves have 1.2x power.",
		gen6: {
	...
	sportball: {
		name: "Sport Ball",
		shortDesc: "A special Poke Ball for the Grass-Catching Contest.",
	},
	starfberry: {
		name: "Starf Berry",
	...
	tr05: {
		name: "TR05",
		shortDesc: "Teaches certain Pokemon the move Water Beam. One use.",
	},
	tr06: {
		name: "TR06",
	...
	tr47: {
		name: "TR47",
		shortDesc: "Teaches certain Pokemon the move Normal Claw. One use.",
	},
	tr48: {
		name: "TR48",
	...
	tr51: {
		name: "TR51",
		shortDesc: "Teaches certain Pokemon the move Normal Dance. One use.",
	},
	tr52: {
		name: "TR52",
	...
	tr57: {
		name: "TR57",
		shortDesc: "Teaches certain Pokemon the move Dark Jab. One use.",
	},
	tr58: {
		name: "TR58",
	...
	tr61: {
		name: "TR61",
		shortDesc: "Teaches certain Pokemon the move Grass Buzz. One use.",
	},
	tr62: {
		name: "TR62",
		shortDesc: "Teaches certain Pokemon the move Normal Pulse. One use.",
	},
	tr63: {
		name: "TR63",
	...
	tr76: {
		name: "TR76",
		shortDesc: "Teaches certain Pokemon the move Stealth Fighting. One use.",
	},
	tr77: {
		name: "TR77",
	...
	vilevial: {
		name: "Vile Vial",
		shortDesc: "If held by a Venomicon, its Dark- and Normal-type attacks have 1.2x power.",
	},
};
