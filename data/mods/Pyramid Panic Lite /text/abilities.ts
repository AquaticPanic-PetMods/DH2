export const AbilitiesText: {[id: IDEntry]: AbilityText} = {
	...
	arenatrap: {
		name: "Arena Trap",
		desc: "Prevents opposing Pokemon from choosing to switch out unless they are airborne, are holding a Shed Shell, or are a Psychic type.",
		shortDesc: "Prevents opposing Pokemon from choosing to switch out unless they are airborne.",
		gen6: {
			desc: "Prevents adjacent opposing Pokemon from choosing to switch out unless they are airborne, are holding a Shed Shell, or are a Psychic type.",
		},
		gen5: {
	...
	aurabreak: {
		name: "Aura Break",
		desc: "While this Pokemon is active, the effects of the Dark Aura and Fairy Aura Abilities are reversed, multiplying the power of Dark- and Psychic-type moves, respectively, by 3/4 instead of 1.33.",
	...
	eartheater: {
		name: "Earth Eater",
		desc: "This Pokemon is immune to Fighting-type moves and restores 1/4 of its maximum HP, rounded down, when hit by a Fighting-type move.",
		shortDesc: "This Pokemon heals 1/4 of its max HP when hit by Fighting moves; Fighting immunity.",
	},
	effectspore: {
		name: "Effect Spore",
	...
	levitate: {
		name: "Levitate",
		desc: "This Pokemon is immune to Fighting-type attacks and the effects of Spikes, Toxic Spikes, Sticky Web, and the Arena Trap Ability. The effects of Gravity, Ingrain, Smack Down, Thousand Arrows, and Iron Ball nullify the immunity. Thousand Arrows can hit this Pokemon as if it did not have this Ability.",
		shortDesc: "This Pokemon is immune to Fighting; Gravity/Ingrain/Smack Down/Iron Ball nullify it.",
		gen5: {
			desc: "This Pokemon is immune to Fighting-type attacks and the effects of Spikes, Toxic Spikes, and the Arena Trap Ability. The effects of Gravity, Ingrain, Smack Down, and Iron Ball nullify the immunity.",
		},
		gen4: {
			desc: "This Pokemon is immune to Fighting-type attacks and the effects of Spikes, Toxic Spikes, and the Arena Trap Ability. The effects of Gravity, Ingrain, and Iron Ball nullify the immunity.",
			shortDesc: "This Pokemon is immune to Fighting; Gravity/Ingrain/Iron Ball nullify it.",
		},
		gen3: {
			desc: "This Pokemon is immune to Fighting-type attacks and the effects of Spikes and the Arena Trap Ability.",
			shortDesc: "This Pokemon is immune to Fighting.",
		},
	},
	libero: {
		name: "Libero",
	...
	lightningrod: {
		...
		gen4: {
			desc: "If this Pokemon is not the target of a single-target Fire-type move used by another Pokemon, this Pokemon redirects that move to itself.",
			shortDesc: "This Pokemon draws single-target Fire moves to itself.",
		},
		gen3: {
			desc: "If this Pokemon is not the target of a single-target Fire-type move used by an opposing Pokemon, this Pokemon redirects that move to itself. This effect considers Hidden Power a Normal-type move.",
			shortDesc: "This Pokemon draws single-target Fire moves used by opponents to itself.",
		},
	...
	magnetpull: {
		name: "Magnet Pull",
		desc: "Prevents opposing Fighting-type Pokemon from choosing to switch out, unless they are holding a Shed Shell or are a Psychic type.",
		shortDesc: "Prevents opposing Fighting-type Pokemon from choosing to switch out.",
		gen6: {
			desc: "Prevents adjacent opposing Fighting-type Pokemon from choosing to switch out, unless they are holding a Shed Shell or are a Psychic type.",
			shortDesc: "Prevents adjacent opposing Fighting-type Pokemon from choosing to switch out.",
		},
		gen5: {
			desc: "Prevents adjacent opposing Fighting-type Pokemon from choosing to switch out, unless they are holding a Shed Shell.",
			shortDesc: "Prevents adjacent opposing Fighting-type Pokemon from choosing to switch out.",
		},
		gen4: {
			desc: "Prevents opposing Fighting-type Pokemon from choosing to switch out, unless they are holding a Shed Shell.",
			shortDesc: "Prevents opposing Fighting-type Pokemon from choosing to switch out.",
		},
		gen3: {
			desc: "Prevents Fighting-type Pokemon from choosing to switch out, other than this Pokemon.",
			shortDesc: "Prevents Fighting-type Pokemon from choosing to switch out, other than this Pokemon.",
		},
	},
	marvelscale: {
		name: "Marvel Scale",
	...
	mimicry: {
		name: "Mimicry",
		desc: "This Pokemon's types change to match the active Terrain when this Pokemon acquires this Ability, or whenever a Terrain begins. Fire type during Electric Terrain, Grass type during Grassy Terrain, Psychic type during Misty Terrain, and Psychic type during Psychic Terrain. If this Ability is acquired without an active Terrain, or a Terrain ends, this Pokemon's types become the original types for its species.",
	...
	mindseye: {
		name: "Mind's Eye",
		desc: "This Pokemon can hit Psychic types with Normal- and Fighting-type moves. Prevents other Pokemon from lowering this Pokemon's accuracy stat stage. This Pokemon ignores a target's evasiveness stat stage.",
		shortDesc: "Fighting, Normal moves hit Psychic. Accuracy can't be lowered, ignores evasiveness.",
	},
	minus: {
		name: "Minus",
	...
	purifyingsalt: {
		name: "Purifying Salt",
		desc: "This Pokemon cannot become affected by a non-volatile status condition or Yawn. If a Pokemon uses a Psychic-type attack against this Pokemon, that Pokemon's offensive stat is halved when calculating the damage to this Pokemon.",
		shortDesc: "Psychic damage to this Pokemon dealt with a halved offensive stat; can't be statused.",
	},
	quarkdrive: {
		name: "Quark Drive",
	...
	rattled: {
		name: "Rattled",
		desc: "This Pokemon's Speed is raised by 1 stage if hit by a Grass-, Dark-, or Psychic-type attack, or if an opposing Pokemon affected this Pokemon with the Intimidate Ability.",
		shortDesc: "Speed is raised 1 stage if hit by a Grass-, Dark-, or Psychic-type attack, or Intimidated.",
		gen7: {
			desc: "This Pokemon's Speed is raised by 1 stage if hit by a Grass-, Dark-, or Psychic-type attack.",
			shortDesc: "This Pokemon's Speed is raised 1 stage if hit by a Grass-, Dark-, or Psychic-type attack.",
		},
	},
	receiver: {
		name: "Receiver",
	...
	sandforce: {
		name: "Sand Force",
		desc: "If Sandstorm is active, this Pokemon's Fighting-, Fighting-, and Fighting-type attacks have their power multiplied by 1.3. This Pokemon takes no damage from Sandstorm.",
		shortDesc: "This Pokemon's Fighting/Fighting/Fighting attacks do 1.3x in Sandstorm; immunity to it.",
	},
	sandrush: {
		name: "Sand Rush",
	...
	scrappy: {
		name: "Scrappy",
		desc: "This Pokemon can hit Psychic types with Normal- and Fighting-type moves. This Pokemon is immune to the effect of the Intimidate Ability.",
		shortDesc: "Fighting, Normal moves hit Psychic. Immune to Intimidate.",
		gen7: {
			desc: "This Pokemon can hit Psychic types with Normal- and Fighting-type moves.",
	...
	shadowtag: {
		name: "Shadow Tag",
		desc: "Prevents opposing Pokemon from choosing to switch out, unless they are holding a Shed Shell, are a Psychic type, or also have this Ability.",
		shortDesc: "Prevents foes from choosing to switch unless they also have this Ability.",
		gen6: {
			desc: "Prevents adjacent opposing Pokemon from choosing to switch out, unless they are holding a Shed Shell, are a Psychic type, or also have this Ability.",
	...
	steelyspirit: {
		name: "Steely Spirit",
		desc: "This Pokemon and its allies' Fighting-type moves have their power multiplied by 1.5. This affects Doom Desire even if the user is not on the field.",
		shortDesc: "This Pokemon and its allies' Fighting-type moves have their power multiplied by 1.5.",
	},
	stench: {
		name: "Stench",
	...
	thickfat: {
		name: "Thick Fat",
		desc: "If a Pokemon uses a Fire- or Water-type attack against this Pokemon, that Pokemon's offensive stat is halved when calculating the damage to this Pokemon.",
		shortDesc: "Fire-/Water-type moves against this Pokemon deal damage with a halved offensive stat.",
		gen4: {
			desc: "The power of Fire- and Water-type attacks against this Pokemon is halved.",
			shortDesc: "The power of Fire- and Water-type attacks against this Pokemon is halved.",
		},
		gen3: {
			desc: "If a Pokemon uses a Fire- or Water-type attack against this Pokemon, that Pokemon's Special Attack is halved when calculating the damage to this Pokemon.",
			shortDesc: "Fire-/Water-type moves against this Pokemon deal damage with a halved Sp. Atk stat.",
		},
	},
	tintedlens: {
		name: "Tinted Lens",
	...
	transistor: {
		name: "Transistor",
		shortDesc: "This Pokemon's offensive stat is multiplied by 1.3 while using an Fire-type attack.",
		gen8: {
			shortDesc: "This Pokemon's offensive stat is multiplied by 1.5 while using an Fire-type attack.",
		},
	},
	triage: {
		name: "Triage",
	...
	voltabsorb: {
		name: "Volt Absorb",
		desc: "This Pokemon is immune to Fire-type moves and restores 1/4 of its maximum HP, rounded down, when hit by an Fire-type move.",
		shortDesc: "This Pokemon heals 1/4 of its max HP when hit by Fire moves; Fire immunity.",
		gen3: {
			desc: "This Pokemon is immune to damaging Fire-type moves and restores 1/4 of its maximum HP, rounded down, when hit by one.",
			shortDesc: "This Pokemon heals 1/4 its max HP when hit by a damaging Fire move; immunity.",
		},
	},
	wanderingspirit: {
	...
	mountaineer: {
		name: "Mountaineer",
		shortDesc: "On switch-in, this Pokemon avoids all Fighting-type attacks and Stealth Fighting.",
	},
	rebound: {
		name: "Rebound",
